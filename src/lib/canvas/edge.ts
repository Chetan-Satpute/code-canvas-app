...
export function drawEdge(ctx: CanvasRenderingContext2D, edge: CanvasEdge) {
  const opacityColorValue = Math.floor(edge.opacity * 255);
...
function drawUndirectedEdge(ctx: CanvasRenderingContext2D, edge: CanvasEdge) {
...
function drawDirectedEdge(ctx: CanvasRenderingContext2D, edge: CanvasEdge) {
  const startNodeCenter = getCenter(edge.startNodePosition);
  const endNodeCenter = getCenter(edge.endNodePosition);
...
function drawBidirectedEdge(ctx: CanvasRenderingContext2D, edge: CanvasEdge) {
  const startNodeCenter = getCenter(edge.startNodePosition);
  const endNodeCenter = getCenter(edge.endNodePosition);
